package io.reactivesw.customer.server.cart.enums.carts;
...
public enum InventoryMode {
   ...
   * items in the carts are only reserved for the duration of the ordering transaction.
   */
  ReserveOnOrder,

  /**
   * Adding items to carts and ordering is independent of inventory. No inventory checks or
   * modifications.
   */
  None;
