...
public class ProductVariantAvailability {
  ...
  @ApiModelProperty(value = "Map of ProductVariantAvailability per Channel id.For each Inventory Entries with a supply channel, an entry is added into channels:\n" +
