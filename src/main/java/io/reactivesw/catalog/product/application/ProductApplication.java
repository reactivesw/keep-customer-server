...
public class ProductApplication {
  ...
  public Product createProduct(ProductDraft productDraft) {
    ...
    validateAttribute(productType.getAttributes(), productDraft);
  ...
  private void validateAttribute(List<AttributeDefinition> attributeDefinitions,
                                 ProductDraft productDraft) {
    if (attributeDefinitions != null && productDraft != null) {
      //2. require的attribute
   ...
   */
  private void validateAttributeName(List<AttributeDefinition> attributeDefinitions,
                                     ProductDraft productDraft) {
   ...
   */
  private List<String> getAttributeDefinitionNames(List<AttributeDefinition> attributeDefinitions) {
   ...
   */
  private List<List<String>> getAllAttributeNames(ProductDraft productDraft) {
   ...
   */
  private List<String> getAttributeNames(List<Attribute> attributes) {
   ...
   * @param productDraft         the product draft
   */
  private void validateProductRequireAttribute(List<AttributeDefinition> attributeDefinitions,
                                               ProductDraft productDraft) {
    ...
    if (requireAttributeNames != null
        && !requireAttributeNames.isEmpty()
   ...
   */
  private void throwExceptionForRequire() {
   ...
   * @param attributes            the attributes
   */
  private void validateRequireAttribute(List<String> requireAttributeNames,
                                        List<Attribute> attributes) {
    if (attributes == null) {
      throwExceptionForRequire();
    }
    List<String> attributeNames = attributes.stream().filter(
        attribute -> attribute.getValue() != null
    ).map(
        attribute -> {
          return attribute.getName();
        }
   ...
   * @param productDraft         the product draft
   */
  private void validateProductUniqueAttribuate(List<AttributeDefinition> attributeDefinitions,
                                               ProductDraft productDraft) {
   ...
   * @param productDraft  the product draft
   */
  private void validateUniqueAttribute(String attributeName, ProductDraft productDraft) {
   ...
   * @param productDraft         the product draft
   */
  private void validateCombinationUniqueAttribute(List<AttributeDefinition> attributeDefinitions,
                                                  ProductDraft productDraft) {
    ...
    if (productDraft.getVariants() != null) {
      attributes.addAll(
          productDraft.getVariants().stream().filter(
   ...
   */
  private void validateCombinationUniqueAttribute(List<String> attributes,
   ...
   * @param productDraft         the product draft
   */
  private void validateSameForAllAttribute(List<AttributeDefinition> attributeDefinitions,
                                           ProductDraft productDraft) {
   ...
   * @param productDraft  the product draft
   */
  private void validateSameForAllAttribute(String attributeName, ProductDraft productDraft) {
   ...
   */
  private List<String> getAttributeNameByConstraint(List<AttributeDefinition>
