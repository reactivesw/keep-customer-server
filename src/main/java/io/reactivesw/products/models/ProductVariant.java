...
import io.reactivesw.products.models.attributes.Attribute;
...
public class ProductVariant {
  ...
  @ApiModelProperty(value="The SKU of the variant.",required = false)
  private String sku;

  @ApiModelProperty(value="User-specific unique identifier for the variant. Product variant keys are different from product keys.",
          required = false)
  private String key;
  ...
  @ApiModelProperty(value = "Only appears when price selection is used. This field cannot be used in a query predicate.", required = false)
  private Price price;
  ...
  @ApiModelProperty(value = "Only appears in response to a Product Projection Search request to mark this variant as one that matches the search query.",
          required = false)
  ...
  @ApiModelProperty(value = "Only appears in response to a Product Projection Search request when price selection is used.",required = false)
